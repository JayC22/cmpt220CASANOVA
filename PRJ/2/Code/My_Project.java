...
public static void title(){
    ...
    //First Monster - Easy
public static void huntBat(){
    Scanner console = new Scanner(System.in);
    System.out.println("A Monster Appeared! Its a Wild Bat! ");
    do
    {
    ...
    if(commandAttack.equalsIgnoreCase("Basic")){
        ...
        System.out.println("-You have done: "
            + attack + " damage");
        monsterBat = monsterBat - attack;
        System.out.println("-The Wild Bat has: "
            + monsterBat + " HP left!\n");
        }
    ...
    if(monsterBat > 0){
        int dmg = (int)(10 + Math.random()*15-10+1);
        hp = hp - dmg; 
        System.out.println("-The Wild Bat has done: " + dmg 
                + " HP of damage to you!\n" + "-You have: "
                + hp + "hp left!\n");
        }
    ...
    int expBat = (int)(5 + Math.random()*50-5+1);
    int goldBat = (int)(5 + Math.random()*10-5+1);
    goldTotal = goldTotal + goldBat;
    expTotal = expTotal + expBat;
    System.out.println("You have gotten: " + expBat
        + " EXP!\nYou picked up: "
        + goldBat + " gold!\n");
    monsterBat = 80;
    }
...
public static void huntTiger(){
    Scanner console = new Scanner(System.in);
    System.out.println("A Monster Appeared! Its a Wild Tiger! ");
    do
    {
    System.out.print("What Skill do you want to use?"
        + "\nBasic,Heal,Item,Run: ");
    ...
    if(commandAttack.equalsIgnoreCase("Basic")){
        ...
        System.out.println("-You have done: "
            + attack + " damage");
        monsterTiger = monsterTiger - attack;
        System.out.println("-The Wild Tiger has: "
            + monsterTiger + " HP left!\n");
        }
    if(commandAttack.equalsIgnoreCase("Heal") && mana >= 2){
        int healing = (int)(10 + Math.random()*35-10+1);
        hp = Math.min(hp + healing, 100);
    ...
    if(monsterTiger > 0){
        int dmg = (int)(14 + Math.random()*45-14+1);
        hp = hp - dmg; 
        System.out.println("-The Wild Tiger has done: " + dmg 
                + " HP of damage to you!\n" 
                + "-You have: " + hp + "hp left!\n");
        }
    if(hp <= 0){ //Die = GameOver
    ...
    while(monsterTiger >= 1);
    //after battle if wins
    int expTiger = (int)(40 + Math.random()*120-40+1);
    int goldTiger = (int)(30 + Math.random()*50-30+1);
    goldTotal = goldTotal + goldTiger;
    expTotal = expTotal + expTiger;
    System.out.println("You have gotten: " + expTiger
        + " EXP!\nYou picked up: "
        + goldTiger + " gold!\n");
    monsterTiger = 200;
    }
...
public static void game(){   // last static void used - User input For Home
    ...
    do
    {
        ...
        if(command.equalsIgnoreCase("Hunt")){
            ...
            if(monsterChance <= 55 && monsterChance > 40){
                huntRat();
            }
            if(monsterChance <=90 && monsterChance > 60){
                huntWeasel();
            }
            if(monsterChance <=100 && monsterChance > 70){
                huntBear();
            }
            if(monsterChance <=100 && monsterChance > 95){
                huntTiger();
            }
        }
